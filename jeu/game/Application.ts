...
import { setSlopeRenderer } from './island/slopes';
...
export async function createApp(
  ...
  // Les rampes lisent et ecrivent des pixels par le renderer plutot que par
  // un canvas 2D (voir island/slopes.ts) : il faut le lui donner avant que
  // le premier terrain ne se construise.
  setSlopeRenderer(pixi.renderer);
